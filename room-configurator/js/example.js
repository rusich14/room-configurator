...
const ContextMenu = function (blueprint3d) {
  ...
  // console.log('=====> blueprint3d 1: ', blueprint3d);
  const scope = this;
  let selectedItem;
  const three = blueprint3d.three;
  ...
  function itemSelected(item) {
    ...
    if (selectedItem.metadata.itemType === 4) {
...
const SideMenu = function (blueprint3dAttr, floorplanControlsAttr, modalEffectsAttr) {
  ...
  function handleWindowResize() {
    ...
    $('#add-furniture, #add-device').height(window.innerHeight);
...
const mainControls = function (blueprint3dAttr) {
  ...
  function loadDesign() {
    ...
    reader.onload = function (event) {
      ...
      // console.log('=====> blueprint3d 2: ', blueprint3d.model.scene.items);
    };
...
const apiControls = function (blueprint3dAttr) {
  ...
  function getItemsList() {
    ...
    parent.postMessage(JSON.stringify(jsonArr), '*');
  }
...
$(document).ready(function () {
  ...
  // console.log('=====> blueprint3d 3: ', blueprint3d);
